...
# Class id of oil in legacy segmentation masks (the oil channel this
# vectoriser extracts). The segmentation metrics module was removed in the
# YOLO-only build; the constant is kept here for the GeoTIFF helpers.
