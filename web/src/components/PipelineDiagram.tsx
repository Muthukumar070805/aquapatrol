...
const STAGES: Stage[] = [
  ...
  { num: "02", name: "Detect", desc: "YOLO oil-candidate detection on scenes and images", live: true, link: "/detect" },
  { num: "03", name: "Characterize", desc: "Oil polygon vectorization, area and shape metrics", live: true, link: "/scenes" },
  { num: "04", name: "Hindcast", desc: "Reverse drift modeling to find probable spill origin", live: true, link: "/hindcast" },
  { num: "05", name: "AIS match", desc: "Correlate vessel tracks with spill location and timing", live: true, link: "/vessels" },
  { num: "06", name: "Suspect score", desc: "Rank nearby vessels by proximity and behaviour", live: true, link: "/vessels" },
